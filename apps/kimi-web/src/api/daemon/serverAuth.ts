...
// and WebSocket call (per-start token, or the KIMI_CODE_PASSWORD password).
// The Web UI obtains that credential in one of two ways:
...
//   2. From a password the user types into the ServerAuthDialog modal.
//
